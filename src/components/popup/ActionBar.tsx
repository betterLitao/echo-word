...
export function ActionBar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <Button icon={<SpeakerHigh size={16} weight="duotone" />} size="sm" variant="ghost" onClick={onSpeak}>朗读</Button>
      ...
      <Button icon={<Copy size={16} weight="duotone" />} size="sm" variant="ghost" disabled={copyDisabled} onClick={onCopy}>{copyLabel}</Button>
