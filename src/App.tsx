              ...
              <div className="relative flex h-full flex-col">
                <div>
                  ...
                  <p className="mt-4 max-w-[28ch] text-sm leading-7 text-slate-400">
                    这是一个偏软件产品的高密度轻玻璃界面：保留呼吸感，但避免常见 AI 紫蓝霓虹和均分三栏卡片的陈词滥调。
                  </p>
                </div>

                <div className="mt-6 flex flex-wrap gap-2">
                  <StatusPill icon={<Lightning size={14} weight="fill" />} label="Cycle 02" tone="accent" />
                  <StatusPill icon={<GridFour size={14} weight="duotone" />} label="离线词典" />
                </div>
                ...
                <div className="mt-auto rounded-[1.6rem] border border-white/10 bg-black/20 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    当前已按中文 commit 节点推进到单词翻译闭环，下一阶段将接入句子翻译、缓存和快捷键触发链路。
                  </p>
                </div>
              </div>
            </aside>
              ...
              <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_300px]">
                ...
                <section className="rounded-[2rem] border border-white/10 bg-black/20 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-2xl">
                  ...
                  <div className="mt-4 space-y-3">
                    <StatusPill icon={<Lightning size={14} weight="fill" />} label="离线翻译可调试" tone="accent" />
                    <StatusPill icon={<HeartStraight size={14} weight="duotone" />} label="收藏可落库" />
                    <StatusPill icon={<ClockCounterClockwise size={14} weight="duotone" />} label="历史待实现" tone="muted" />
                  </div>
                </section>
              </div>
